...
# 参数设置
text_folder = r'D:\self_document\Australia\UNSW\2024\T3\COMP9444\group_p\VisDrone2019-DET-train\copy_annotions'  # 存放文本文件的文件夹路径
target_folder = r'D:\self_document\Australia\UNSW\2024\T3\COMP9444\group_p\VisDrone2019-DET-train\11'  # 存放符合条件文本文件的目标文件夹路径
target_categories = [11]  # 目标类别678911
threshold = 15# 数量阈值，可以调整
