...
def find_and_copy_majority_class_files(text_folder, target_folder, target_classes, threshold=0.9):
...
# 参数设置
text_folder = r'D:\self_document\Australia\UNSW\2024\T3\COMP9444\group_p\VisDrone2019-DET-train\n_annotions'  # 替换为存放文本文件的文件夹路径
target_folder = r'D:\self_document\Australia\UNSW\2024\T3\COMP9444\group_p\VisDrone2019-DET-train\4_over70%'  # 替换为目标文件夹路径
target_classes = [4]  # 目标类别
threshold = 0.7  # 阈值为70%
