...
# 参数设置
image_source_folder = r'D:\self_document\Australia\UNSW\2024\T3\COMP9444\group_p\VisDrone2019-DET-train\images'  # 包含所有图片的文件夹路径
text_source_folder = r'D:\self_document\Australia\UNSW\2024\T3\COMP9444\group_p\VisDrone2019-DET-train\n_annotations'  # 包含所有文本文件的文件夹路径

reference_folders = [r'D:\self_document\Australia\UNSW\2024\T3\COMP9444\group_p\VisDrone2019-DET-train\1_over',
                     r'D:\self_document\Australia\UNSW\2024\T3\COMP9444\group_p\VisDrone2019-DET-train\4_over']  # 包含目标文件的两个参考文件夹路径
