...
def main():
    ...
    # 创建保存图像和描述文件的目标文件夹
    img_save_dir = r'D:\self_document\Australia\UNSW\2024\T3\COMP9444\group_p\VisDrone2019-DET-train\After_Aug1'#保存纯图片
    bbox_img_save_dir = r'D:\self_document\Australia\UNSW\2024\T3\COMP9444\group_p\VisDrone2019-DET-train\After_Aug_bbox1'#保存有bbox图片
    anno_save_dir = r'D:\self_document\Australia\UNSW\2024\T3\COMP9444\group_p\VisDrone2019-DET-train\After_Aug_text_Normalization1'#保存归一化后的图片
