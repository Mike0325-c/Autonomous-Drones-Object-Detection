...
def yolo_to_coco_for_subset(yolo_images_folder, yolo_labels_folder, categories):
    ...
    for image_file in glob.glob(f"{yolo_images_folder}/*.bmp"):
        ...
        yolo_annotation_file = os.path.join(yolo_labels_folder, os.path.basename(image_file).replace(".bmp", ".txt"))
...
# Example usage
yolo_base_folder = r"E:\AAAAAA_FInal_data\yolo2json"#yolo标签地址
