...
# 参数设置
source_folders = [
    r'D:\self_document\Australia\UNSW\2024\T3\COMP9444\group_p\VisDrone2019-DET-train\0',  # 替换为类别0的文件夹路径
    ...
    r'D:\self_document\Australia\UNSW\2024\T3\COMP9444\group_p\VisDrone2019-DET-train\11'  # 替换为类别11的文件夹路径
]
